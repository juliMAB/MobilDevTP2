...
public class JLogger
{
    ...
    const string EXAMPLEDIALOGQ_CLASS_NAME = "ExampleDialoq";
    ...
    static AndroidJavaClass ExampleDialoqClass = null;

    static AndroidJavaObject ExampleDialoqInstance = null;
    ...
    static void init()
    {
        ...
        ExampleDialoqClass = new AndroidJavaClass(PACK_NAME + "." + EXAMPLEDIALOGQ_CLASS_NAME);
        ExampleDialoqInstance = ExampleDialoqClass.CallStatic<AndroidJavaObject>("GetInstance");
    ...
    {
#if UNITY_ANDROID && !UNITY_EDITOR
        if(ExampleDialoqInstance==null)
            init();
        ExampleDialoqInstance.Call("openDialog");
